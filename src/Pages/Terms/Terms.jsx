...
export default function Terms() {
    return (
        <div>
            <ScrollToTopOnMount />
            <section className="section term__of_use p-8 md:p-0">
                <div className="container terms__container">
                    <h1 className='mt-32 texts-dark mb-8'>Terms & Conditions</h1>
                    <p>These Terms of Service (the “Terms”) govern your use of Internet websites or other methods of accessing any of the services (collectively, the “Service”) offered by (Breedss.com, referred to as “we” or “us”). By accessing the Service on any of our platforms, you warrant and represent that you have read, understand, and agree to all terms and conditions stated herein, and you agree to be legally bound by them. If by any chance you don’t agree with any of the terms and conditions in this policy, do not use the Service. YOU SHOULD BE AT LEAST (18) YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</p>
                    <p>The Company may revise these Terms at any time without prior notice. You will be deemed to have accepted those changes by, among other things, continuing to access or use the Services. You agree to comply with all applicable laws and regulations. The materials provided on or through the Services are protected by law, including, but not limited to, (United States copyright laws and international treaties). The terms "you," "your," "user," and "users," as used herein, refer to all individuals and/or entities accessing or using the Services for any reason or otherwise providing assent. Your use of the Services may be subject to additional terms in connection with certain programs, goods, or services associated with Breedss.</p>
                    <p>The Company may revise these Terms at any time without prior notice. You will be deemed to have accepted those changes by, among other things, continuing to access or use the Services. You agree to comply with all applicable laws and regulations. The materials provided on or through the Services are protected by law, including, but not limited to, (United States copyright laws and international treaties). The terms "you," "your," "user," and "users," as used herein, refer to all individuals and/or entities accessing or using the Services for any reason or otherwise providing assent. Your use of the Services may be subject to additional terms in connection with certain programs, goods, or services associated with Breedss.</p>
                    ...
                    <div className="terms__container-content">
                        <h2>Accounts</h2>
                        <p> <strong>Account Creation :</strong> These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and also limit the remedies available to you in the event of a dispute.</p>
                        ...
                        <p> <strong>Certain Restrictions :</strong> Company grants you a non-transferable, non-exclusive, revocable, limited license to access the Site solely for your own personal, noncommercial use.</p>
                        <p> <strong>No Support or Maintenance :</strong> YYou agree that Company will have no obligation to provide you with any support in connection with the Site.
                        ...
                        <p><strong>Other Users:</strong>
                            ...
                            <br /><br />You hereby release and forever discharge the Company and our officers, employees, agents, successors, and assigns from, and hereby waive and relinquish, each and every past, present and future dispute, claim, controversy, demand, right, obligation, liability, action and cause of action of every kind and nature, that has arisen or arises directly or indirectly out of, or that relates directly or indirectly to, the Site. If you are a California resident, you hereby waive California civil code section 1542 in connection with the foregoing, which states: “a general release does not extend to claims which the creditor does not know or suspect to exist in his or her favor at the time of executing the release, which if known by him or her must have materially affected his or her settlement with the debtor.”

                        </p>


                        <p><strong>Cookies and Web Beacons.</strong>   Like any other website, Website Name uses ‘cookies’. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
                        <p><strong>Google DoubleClick DART Cookie.</strong>  Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.breedss.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – https://policies.google.com/technologies/ads</p>
